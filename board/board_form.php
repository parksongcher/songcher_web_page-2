...
<head>
	...
	<link rel="stylesheet" href="http://<?= $_SERVER["HTTP_HOST"] ?>/psctest/songcher_web_site/css/footer.css?after">
	<link rel="stylesheet" href="http://<?= $_SERVER["HTTP_HOST"] ?>/psctest/songcher_web_site/board/css/board.css?after2">
	<script src="http://<?= $_SERVER['HTTP_HOST'] ?>/psctest/songcher_web_site/board/js/board.js" defer></script>
...
<body>
	...
	<section>
		...
		//$_POST["mode"]값이 세팅이 되어있지 않으면 삽입(insert) 해당폼을 이용하겠다
		//$mode = "insert" 기본값으로 세팅됨
