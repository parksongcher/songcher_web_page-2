...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/psctest/songcher_web_site/admin/css/admin.css?after">
	...
	<section>
		<div id="admin_box">
			...
			<ul id="member_list">
				...
				$sql = "select * from lostark order by num desc";
				...
				//가르킬 레코드 위치가 없으며 null을 리턴한다 = false
