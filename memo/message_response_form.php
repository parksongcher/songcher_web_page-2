...
<head>
	...
	<link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/psctest/songcher_web_site/css/main.css">
...
<body>
	...
	<section>
		<?php include $_SERVER['DOCUMENT_ROOT'] . "/psctest/songcher_web_site/main_img_bar.php"; ?>
		<div id="message_box">
			<h3 id="write_title">
