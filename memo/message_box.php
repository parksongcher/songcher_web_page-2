...
<head>
    <meta charset="utf-8">
    <title>박성철 페이지</title>
    <link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/psctest/songcher_web_site/css/main.css">
    <link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/psctest/songcher_web_site/memo/css/message.css?after">
    <link rel="stylesheet" type="text/css" href="http://<?= $_SERVER['HTTP_HOST'] ?>/psctest/songcher_web_site/css/footer.css">
    <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
    <script src="http://<?= $_SERVER['HTTP_HOST']; ?>/psctest/songcher_web_site/memo/js/message.js"></script>
...
<body>
            ...
            <div>
                <ul id="message">
                    ...
                    for ($i = $start; $i < $start + $scale && $i < $total_record; $i++) {
                        ...
                        // 전송이면 수신아이디 , 수신이면 송신아이디
                        // 송신아이디 또는 수신아이디 이름을 가져옴.
                        if ($mode == "send")
                            $msg_id = $row["rv_id"];
                        else
                            $msg_id = $row["send_id"];
    ...
    <footer>
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/psctest/ka_web_page/footer.php' ?>
